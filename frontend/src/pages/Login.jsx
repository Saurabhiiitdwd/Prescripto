        ...
        <button type='submit' className='bg-primary text-white w-full py-2 rounded-md text-base'>{state === 'Sign Up' ? 'Create Account' : 'Login'}</button>
        {
          state === 'Sign Up' ? (
            <p className='text-sm text-center'>
              ...
              <button type="button" className='text-primary hover:underline' onClick={() => setState('Login')}>
                Login
              </button>
            </p>
          ) : (
            <p className='text-sm text-center'>
              ...
              <button type="button" className='text-primary hover:underline' onClick={() => setState('Sign Up')}>
                Sign Up
              </button>
            </p>
          )
